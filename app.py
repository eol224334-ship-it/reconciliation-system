...
def review_workbench_generate():
    ...
    try:
        ...
        system_prompt = (
            ...
            "1. 每条最终评价由 3-5 条独立短评语组合而成，短评之间自然衔接，像一个真实买家随手打出来的整体感受。\n"
            "2. 这些短评必须独立成句，不要把通用评价和产品评价融合成一句话。分为两类：\n"
            "   - 通用评价语：围绕快递、物流时效、商家服务、产品质量、正品保障、保修售后等角度，口语化、真实，不分品牌、不分产品都适用。\n"
            "   - 产品评价语：结合我们产品卖点和竞品类目评论的表达角度，突出 1-2 个产品卖点，不要罗列所有卖点。\n"
        ...
        answer = ai_chat(messages, temperature=0.9, max_tokens=4096)
